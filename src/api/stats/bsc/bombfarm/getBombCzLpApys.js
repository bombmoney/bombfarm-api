...
const pools = require('../../../../data/bombCzLpPools.json');
...
const rewardPool = '0x6dDb381481c4282CCe9b64241f0bcB17C562744D';
const oracleId = 'CZSHARES';
const oracle = 'tokens';
const DECIMALS = '1e18';

const getBombCzLpApys = async () => {
  let promises = [];
...
module.exports = getBombCzLpApys;
